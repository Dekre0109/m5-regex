...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        // and be at least minLength characters long.
        String regex = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d).{" + minLength + ",}$";
        return Pattern.matches(regex, str);
    }

    // Method 2: extractEmails

    /**
     * Returns a list of email addresses that occur in a given string.
     * Only emails with domain @mail.utoronto.ca or @utoronto.ca and
     * at least one character before '@' are included.
     *
    ...
    public static List<String> extractEmails(String str) {
        ...
        // One or more valid local-part chars, then @,
        // then optional "mail.", then "utoronto.ca"
    ...
    public static boolean checkForDoubles(String str) {
        ...
        // Any characters, then capture a capital letter [A-Z],
        // then any characters, then the same letter again.
